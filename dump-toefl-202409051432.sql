...
INSERT INTO `exam_results` VALUES (4,1,9,12,12,12,'2024-09-05 00:22:38','2024-09-05 07:28:18',NULL);
...
INSERT INTO `exam_statuses` VALUES (2,'Completed'),(1,'In Progress');
...
CREATE TABLE `exams` (
  ...
  KEY `user_id` (`user_id`),
  KEY `fk_exam_status` (`status_id`),
  CONSTRAINT `exams_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  CONSTRAINT `fk_exam_status` FOREIGN KEY (`status_id`) REFERENCES `exam_statuses` (`id`)
...
INSERT INTO `exams` VALUES (9,1,NULL,2);
...
-- Dump completed on 2024-09-05 14:32:09
